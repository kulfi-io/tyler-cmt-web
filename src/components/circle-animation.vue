  ...
  <div class="circle-container">
    ...
    >
      <g class="circle-animation">
        ...
        <g class="text-content" data-name="text-content">
          <g>
            <polygon
          ...
          <g>
            <g>
              <line y1="131.47" x2="186.05" y2="98.59" fill="none" x1="35.47"></line>
              <text transform="matrix(1.05, -0.23, 0.22, 0.98, 132.63, 225.17)">
                <tspan y="0.2" x="24.05">{{title}}</tspan>
              </text>
            </g>
            ...
            <rect
              ...
              x="152.606"
              y="219.751"
              transform="matrix(0.9774 -0.2115 0.2115 0.9774 -40.0389 47.9254)"
            ></rect>
...
<script lang="ts">
import Vue from 'vue';
import '../assets/sass/circle.scss';
