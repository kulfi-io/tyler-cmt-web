export class Account {
    constructor() {
        ...
        this.showPassword = (elm) => {
            ...
            if (_targetName) {
                var _target = document.getElementById(_targetName);
                if (_target) {
